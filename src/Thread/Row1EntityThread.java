                ...
                if (tile.isAdaTanaman()){
                    ...
                    for (Zombie z : tile.getZombieList()){
                        if (z instanceof CanJump){
                            ...
                            if (zj.alreadyJumped()==false && Map.getMapInstance().getMapDetail()[0][i-1].isAdaTanaman()==true){
                                zj.jump();
                                if (Map.getMapInstance().getMapDetail()[0][i-1].getPlant().isJumpable()==true){
                                    Map.getMapInstance().getMapDetail()[0][i-1].plantDie();
                                }
                                z.setTimeSpawn();
