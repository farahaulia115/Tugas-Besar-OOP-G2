...
public class PolevaultingZombie implements Zombie {
    ...
    public PolevaultingZombie(String name, int health, int damage, int speed, boolean aquatic, int x, int y, int timeSpawn, int moveInterval, boolean slowed, int timeSlowed, int slowDuration) {
        this.name = name;
        this.health = health;
        this.damage = damage;
        this.speed = speed;
